...
urlpatterns = [
    ...
    path('modificarusuario/<int:pk>/', views.actualizar_Usuario, name="modificarusuario"),
    path('eliminar/usuario/<int:pk>/', views.eliminar_usuarios, name="modificarusuario"),
    path('lista/usuarios/', views.lista_user, name="listausuarios"),
